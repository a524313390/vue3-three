...
onMounted(() => {
    ...
    const pointGeometore = new THREE.BufferGeometry();
    const count = 5000;
    //设置缓冲区数据
    ...
    pointGeometore.setAttribute('position', new THREE.BufferAttribute(position, 3))
    pointGeometore.setAttribute('color', new THREE.BufferAttribute(colors, 3))
    // scene.add(mesh)
    ...
    const points = new THREE.Points(pointGeometore, pointMaterial);
